...
export class SearchComponent implements OnInit, OnDestroy {
  ...
  private static searchExtension: string = '';
  ...
  public constructor(
    ...
    this.extension = new FormControl(SearchComponent.searchExtension);
  ...
  public ngOnInit(): void {
    ...
    this.subscriptions = [
      ...
      this.extension.valueChanges.subscribe(() => this.search(true))
    ];
    if (this.isUpdated()) {
      this.search(false);
    }
  ...
  public search(emitSearchStart: boolean): void {
    ...
    this.filesSearchService.searchFiles({
  ...
  public ngOnDestroy(): void {
    ...
    SearchComponent.searchExtension = this.extension.value;
